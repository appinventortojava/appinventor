...
static class AboutDialogBox extends DialogBox {
    ...
    AboutDialogBox(String projectName) {
      ...
      HTML warningLabel = new HTML("<p>About: </p>" +
        ...
        "break on others. We encourage you to use the tool and appreciate any feedback you can give us "+
        "(please post to the googlegroups usfappinvtojava )</p> " +

        "<p> The following tutorial apps from appinventor.org have been tested and generate valid Java code: </p>" +

        "<p> -Hello Purr </p>" +
        "<p> -Map Tour </p>" +
        "<br /> <p> The following work, after casting issues are resovled: </p>" +
        "<p> Mole Mash </p>" +
        "<p> Paint Pot </p>" +
        "<p> No texting while Driving </p>" +


        "<p> You can generate either Java files or an entire Eclipse project, including the Java files and the link "+
        "to the Java Bridge Library. The Eclipse files contain the Java Bridge library and the generated Java code. </p>" +
        ...
        " - You will need to cast to speccific types <br /> " +

        "<p> Please post your feedback and bugs/limitations to the googlegroups usfappinvtojava or send an email to " +
        "java.appinventor@gmail.com </p>" +

        "App Inventor to Java is being developed by the <a href=\"http://democratizecomputing.org\">Democratize "+
