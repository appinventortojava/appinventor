...
import com.google.appinventor.client.explorer.commands.ShowAboutCommand;
...
public class DesignToolbar extends Toolbar {
  ...
  private static final String ABOUT_URL = Ode.APP_INVENTOR_DOCS_URL + "/learn/";
  ...
  public DesignToolbar() {
    ...
    sourceItems.add(new ToolbarItem(WIDGET_NAME_ABOUT, MESSAGES.tabReadMe(), 
            new AboutAction()));
  ...
  private class AboutAction implements Command {
    @Override
    public void execute() {
      ProjectRootNode projectRootNode = Ode.getInstance().getCurrentYoungAndroidProjectRootNode();
      if (projectRootNode != null) {
          String target = YoungAndroidProjectNode.YOUNG_ANDROID_TARGET_ANDROID;
          ChainableCommand cmd = new ShowAboutCommand(target);
